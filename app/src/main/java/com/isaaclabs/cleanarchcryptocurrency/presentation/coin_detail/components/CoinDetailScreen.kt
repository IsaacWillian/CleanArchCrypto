...
import com.isaaclabs.cleanarchcryptocurrency.presentation.coin_detail.CoinDetailViewModel
import com.isaaclabs.cleanarchcryptocurrency.presentation.coin_list.CoinListViewModel
        ...
        state.coin?.let { coin ->
            LazyColumn(modifier = Modifier.fillMaxSize()) {
                item {
                    ...
                    Spacer(modifier = Modifier.height(15.dp))
                    Text(text = "Team Member", style = MaterialTheme.typography.headlineSmall)
